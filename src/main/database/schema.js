  ...
  await withTransaction(async (client) => {
    ...
    await client.query(`
      ...
      FROM (VALUES
        ...
        ('barcodes.labels.validate','BARCODES','Validate barcode labels'),
        ('barcodes.print.request','BARCODES','Request barcode printing'),
        ('barcodes.print.execute','BARCODES','Execute barcode printing'),
